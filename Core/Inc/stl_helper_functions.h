#ifndef CAN_MOTOR_CONTROLLER_CORE_INC_STL_HELPER_FUNCTIONS_H_
#define CAN_MOTOR_CONTROLLER_CORE_INC_STL_HELPER_FUNCTIONS_H_
...
#endif // CAN_MOTOR_CONTROLLER_CORE_INC_STL_HELPER_FUNCTIONS_H_
